...
1. **Garmin FIT File:** Contains time series data for Heart Rate (HR), Power, Speed, Time, etc.  
...
Your submission must be a single, fully reproducible GitHub repository containing the following, with quality and clarity being paramount.
...
* **Evaluation Focus:**  
  * **Code Quality & Best Practices:** We highly value **readability, maintainability, clear comments**, appropriate **error handling** (especially during file processing/DB interaction), and adherence to consistent code style.  
  * **Documentation:** A complete **README.md** with **Setup/Run Instructions** (detailed steps to run all components) and a comprehensive **Architecture Overview**.
...
* **Web Dashboard & Mobile Client:** Functional prototypes meeting all requirements in Sections 2 and 3\.  
* **Evaluation Focus:**  
  * **Visuals & UX:** We highly value **great, clear, and simple visuals** supporting both the web dashboard and mobile application interfaces. Focus on a clean and usable User Experience (UX).
...
* **Evaluation Focus:**  
  * **Creativity & Problem Solving:** We highly value your ability to **propose new solutions** or make intelligent assumptions in the absence of explicit information (e.g., handling missing data points, suggesting better data structures).  
  * **Presentation Clarity:** The slides should use **clear and simple visuals** to communicate complex ideas effectively.
